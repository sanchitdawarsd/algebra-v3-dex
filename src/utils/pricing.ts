...
const USDC_WMatic_03_POOL = '0x86d1da56fc79accc0daf76ca75668a4d98cb90a7'
...
log.info('price0USD: {}, price1USD: {} tokenAmount0:{} tokenAmount01:{}', [price0USD.toString(), price1USD.toString(),tokenAmount0.toString() , tokenAmount1.toString() ])    
